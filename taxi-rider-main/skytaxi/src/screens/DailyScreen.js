...
//   allCabs = '';
 ...
 allCarsData(){
    const cars=firebase.database().ref('rates/car_type').orderByChild('category').equalTo('Car');
    ...
    return (
      <View style={styles.mainViewStyle}>
        <Header 
            ...
            centerComponent={<Text style={styles.headerTitleStyle}>Daily Rides</Text>}
        ...
        <View style={styles.compViewStyle}>
            ...
            <ScrollView horizontal={true} style={styles.adjustViewStyle} showsHorizontalScrollIndicator={false}>
                ...
                <TouchableOpacity key={key} style={styles.cabDivStyle} onPress={()=>{this.selectCarType(prop,key)}} disabled={prop.minTime == ''} >
                    ...
                    backgroundColor: prop.active == true?'#697174':'#697174', borderColor: prop.active == true?'#000':'#697174'}]
                    }>
