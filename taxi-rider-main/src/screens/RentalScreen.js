...
export default class RentalScreen extends React.Component {
    ...
    //   allCabs = '';
     ...
     allCarsData(){
        const cars=firebase.database().ref('rates/car_type').orderByChild('category').equalTo('Bike');
        ...
        return (
          <View style={styles.mainViewStyle}>
            <Header 
                ...
                centerComponent={<Text style={styles.headerTitleStyle}>Bike Rides</Text>}
            ...
            <View style={styles.compViewStyle}>
                ...
                <ScrollView horizontal={true} style={styles.adjustViewStyle} showsHorizontalScrollIndicator={false}>
                    ...
                    <TouchableOpacity key={key} style={styles.cabDivStyle} onPress={()=>{this.selectCarType(prop,key)}} disabled={prop.minTime == ''} >
                        ...
                        backgroundColor: prop.active == true?'#424242':'#424242', borderColor: prop.active == true?'#000':'#697174'}]
                        }>
