...
//   allCabs = '';
 ...
 _getLocationAsync = async () => {
   ...
   onPressDaily() {
    this.props.navigation.navigate('DailyScreenPage');
   }
   onPressRental() {
    this.props.navigation.navigate('RentalScreenPage');
   }

   onPressOutstation() {
    this.props.navigation.navigate('OutstationScreenPage');
   }
  ...
  render() {
    return (
      <View style={styles.mainViewStyle}>
        ...
        <View style={styles.myViewStyle} style={{display:'none'}}>
        ...
        <View style={styles.compViewStyle}>
            <Text style={styles.pickCabStyle}>SELECT YOUR RIDE TYPE</Text>
            ...
            <ScrollView horizontal={true} style={styles.adjustViewStyle} showsHorizontalScrollIndicator={false}>
                ...
                <TouchableOpacity style={styles.cabDivStyle} onPress={()=>{this.onPressDaily()}} >
                    <View style={styles.imageStyle}>
                        <Image source={require('../../assets/images/microBlackCar.png')} style={styles.imageStyle1} />
                    </View>
                    <View style={styles.textViewStyle}>
                         <Text style={styles.text1}>CAR</Text> 
                        
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={styles.cabDivStyle}  onPress={()=>{this.onPressRental()}} >
                    <View style={styles.imageStyle}>
                        <Image source={require('../../assets/images/Biker-512.png')} style={styles.imageStyle1} />
                    </View>
                    <View style={styles.textViewStyle}>
                ...
                <TouchableOpacity style={styles.cabDivStyle} onPress={()=>{this.onPressOutstation()}} >
                    <View style={styles.imageStyle}>
                        <Image source={require('../../assets/images/tuktuk.jpg')} style={styles.imageStyle1} />
                    </View>
                    <View style={styles.textViewStyle}>
                         <Text style={styles.text1}>KEKE</Text> 
