...
import { place_api_key } from '../common/key';

export default class SearchScreenoutstation extends Component {
    componentWillMount() {
    ...
    goMap(data,details,from) {
        if(from=="where") {
            ...
            this.props.navigation.replace('OutstationScreenPage',{ searchObj: searchObj,old:oldData});           
        }
        else if(from=='drop'){
            let searchObj = {
                searchData: data, 
