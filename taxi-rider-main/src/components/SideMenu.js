        ...
        return(
            <View style={styles.mainViewStyle}>
                ...
                <View style={{padding:10, marginBottom:10}}>
                    <TouchableOpacity 
                        onPress={() => this.driver()}
                        style={{backgroundColor:'green', borderRadius:5, padding:10}}
                    >
                        <Text style={{color:'white', fontWeight:'700', fontSize:18}}>Become a driver</Text>
                        <Text style={{color:'white'}}>Earn money on your schedule</Text>
                        {/* <Icon
